...
public class Shader{
  ...
  float[] matarray;//working area for transform from PMVMatrix to float[] 
  ...
  public void setMatrixAndLight(GL2ES2 gl, PMVMatrix mats, Vec3 lightpos,
    ...
    mats.getPMat().get(matarray);
    mats.getMvMat().get(matarray,16);
    mats.getMvitMat().get(matarray,48);
    gl.glUniformMatrix4fv(uniformMat, 4, false, matarray,0);
